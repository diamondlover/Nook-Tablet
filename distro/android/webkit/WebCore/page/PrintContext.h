...
public:
    ...
    void spoolPageBand(GraphicsContext& ctx, int pageNumber, float width, const IntRect& bandRect, float scale);
    int getPageHeight(int pageNumber, const FloatRect& printRect, float userScaleFactor);
