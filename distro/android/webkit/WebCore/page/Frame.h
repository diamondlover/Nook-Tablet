...
public:
        int  renderBegin(int pageWidth, int pageHeight, int printDpi, bool renderLandscape);
        void renderSetReverseOrder(bool renderReverseOrder);
        void renderSetGrayscale(bool renderGrayscale);
        void renderSetBackgroundPrinting(bool renderBackground);
        void checkRenderSwathHeight(int page, int y, int& swathHeight);
        bool renderSwath(int page, int y, int swathHeight, int* pixelArray, char* rbgArray, bool reverseRGB, bool mayRender);
        void renderEnd();

private:
        void remapRenderBand();
        IntRect *m_sourceRect;
        IntRect *m_renderRect;
        IntRect *m_swathRect;
        int m_renderPageWidth;
        int m_renderPageHeight;
        int m_renderPrintDpi;
        bool m_renderLandscape;
        bool m_renderReverseOrder;
        bool m_renderGrayscale;
        bool m_renderBackground;
        int m_renderSwathHeight;
        int m_firstRenderedSwathIndex;
        int m_lastRenderedPageIndex;
        float m_renderZoomFactor;
        FloatRect m_renderPageRect;
        PrintContext *m_renderPrintContext;
        PlatformGraphicsContext *m_printGraphicsContext;
        GraphicsContext *m_graphicContext;
        SkBitmap *m_bitmapDevice;
